...
ESTJ: {
  ...
  summary:
    "공동체가 안정적으로 운영되도록 기반을 단단히 세우는 실천형 리더입니다. 시간·안전·준비·예산처럼 대부분이 지나치는 요소를 빠르게 파악하고, 위험이나 혼란의 가능성을 즉각적으로 점검합니다. 복잡한 상황에서도 중심을 잡고 질서를 회복하며, 사람들에게 ‘저 사람이 있으면 괜찮다’는 든든함을 줍니다.",
  ...
  bibleCharacter: "모세",
  bibleCharacterDesc:
    "광야에서 질서를 세우고 백성을 인도했던 리더. 책임감과 충성을 다해 공동체를 붙들었던 모습이 ESTJ와 닮았습니다.",
  verseRef: "민수기 12:7",
  verseText: "“내 종 모세는 그렇지 아니하니 그는 나의 온 집에 충성됨이라”",
  characterEmoji: "🛡️",
  characterTitle: "광야 진영의 질서 담당 장교",
  characterStory:
    "예배 준비의 시간표·자리·동선·안전 등을 빠르게 파악해 흐트러진 현장을 정돈하는 사람입니다. 모두가 알아차리기 전에 문제를 발견하고 필요한 사람들을 모아 간단하게 브리핑하며, 예배와 모임이 제시간에 안정적으로 흘러가도록 보이지 않는 곳에서 기반을 붙잡아 줍니다. 사람들은 크게 드러나지는 않지만 ‘누군가 뒤에서 잡아줬구나’라는 안도감을 느낍니다.",
  ministries: [
  ...
  strengthShort:
    "책임감과 실행력이 강하고, 위험을 미리 감지하며 안전한 질서를 세우는 데 탁월합니다.",
  weaknessShort:
    "말투와 태도가 딱딱하게 전달될 수 있으며, 일을 혼자 처리하려다 과부하가 생길 수 있습니다.",
  warningShort:
    "원칙을 지키는 과정에서 관계가 경직되지 않도록, 말 한마디와 표정의 온도를 한 번 더 바라보면 좋습니다.",
  verseApply:
    "당신의 충성스러운 섬김 뒤에서 하나님이 공동체를 붙들고 계십니다. 모든 책임을 혼자 지려 하기보다, ‘주님이 이미 책임지고 계신다’는 사실을 고백하며 한 걸음 내려놓아 보세요."
},
...
ESFJ: {
  ...
  summary:
    "공동체 안에 자연스럽게 ‘정서적 안전지대’를 만드는 사람입니다. 흐려진 표정, 평소와 다른 참석 여부, 조용히 앉아 있는 아이의 분위기까지 세심하게 살피며 먼저 다가갑니다. 스쳐 지나가는 인사 속에서도 지난 대화를 기억해 주어, 사람들에게 ‘나는 잊히지 않았다’는 깊은 위로와 안정감을 선물합니다.",
  ...
  bibleCharacter: "마르다",
  bibleCharacterDesc:
    "섬김과 환대에 분주하면서도 사랑받는 자리 안에 있었던 마르다처럼, 공동체의 실제 필요를 누구보다 잘 돌보는 모습이 ESFJ와 닮았습니다.",
  verseRef: "요한복음 11:5",
  ...
  strengthShort:
    "사람들을 세심하게 기억하고 돌보며, 공동체에 포근하고 안전한 정서를 만들어 줍니다.",
  weaknessShort:
    "거절과 한계 설정이 서툴러 마음과 몸이 쉽게 지치고, 속으로 서운함이 쌓일 수 있습니다.",
  warningShort:
    "모든 사람의 감정을 책임지려다 보면 정작 나 자신의 마음과 하나님과의 깊은 시간을 잃어버릴 수 있습니다.",
  verseApply:
    "예수께서 마르다를 사랑하셨던 것처럼, 바쁘고 지친 당신의 섬김도 주님의 시선 안에 있음을 기억하게 합니다. 오늘은 누군가를 먼저 챙기기 전에, 하나님 앞에서 나 자신에게 ‘괜찮아, 수고했다’고 말해 주는 회복의 순간을 허락해 보세요."
},
 ...
 ENTJ: {
  ...
  summary:
    "복잡한 상황 속에서도 핵심을 빠르게 추려 내고, 공동체가 향해야 할 방향을 선명하게 제시하는 리더입니다. 흐릿해진 목표 속에서 “지금 우리가 가야 할 길은 여기입니다”라고 말하며 흐름을 재정리하고, 비전을 계획·지표·일정으로 구체화해 실제 움직임을 만들어 갑니다. 당신이 나서는 자리에는 방향과 속도가 동시에 생기고, 흩어져 있던 에너지가 한 목표를 향해 모입니다.",
  ...
  bibleCharacter: "느헤미야",
  bibleCharacterDesc:
    "무너진 성벽을 재건하기 위해 상황을 파악하고 비전을 선포하며, 사람들을 조직해 실행한 리더. 비전과 전략, 실행력이 조화를 이루는 모습이 ENTJ와 닮았습니다.",
  verseRef: "느헤미야 2:18",
  ...
  strengthShort:
    "큰 그림과 전략을 제시하고, 사람과 자원을 조직해 실제 변화를 만들어내는 추진력이 탁월합니다.",
  weaknessShort:
    "목표와 효율에 집중하는 나머지, 느리게 움직이는 사람들의 감정과 속도를 놓칠 위험이 있습니다.",
  warningShort:
    "사역의 성과와 속도가, 한 사람의 눈물과 마음보다 앞서지 않도록 의도적으로 ‘사람의 이야기’를 먼저 듣는 훈련이 필요합니다.",
  verseApply:
    "하나님이 시작하신 ‘선한 일’은 당신의 전략과 리더십을 통해 진행되지만, 완성하시는 분은 결국 하나님이심을 기억하게 합니다. 오늘은 회의나 계획을 시작하기 전에 잠시 멈추어, ‘주님, 이 비전과 계획의 주인은 제가 아니라 주님이십니다’라고 고백하며 방향과 속도를 맡겨 보세요."
},
...
ENFJ: {
  ...
  nameEn: "The Inspirer",
  summary:
    "사람 안에 숨겨진 가능성을 놀랄 만큼 빠르게 포착하고, 그 가능성을 비전으로 끌어 올리는 감동형 리더입니다. 다른 이들이 보지 못하는 잠재력을 먼저 알아보고, 짧은 한마디로도 큰 용기를 심어 줍니다. 흩어진 이야기를 한 줄로 모으고, 각자의 삶에서 하나님이 일하신 흔적을 보게 하며, 사람들로 하여금 ‘나도 하나님 안에서 걸어갈 수 있겠다’는 소망을 품게 합니다.",
  ...
  bibleCharacter: "바나바",
  bibleCharacterDesc:
    "사람 안의 은혜와 가능성을 보고 위로와 격려로 세웠던 동역자. 사역자를 발굴하고 세우며, 많은 이들을 주님께로 연결했던 모습이 ENFJ와 잘 닮았습니다.",
  verseRef: "사도행전 11:24",
  ...
  strengthShort:
    "사람 안의 가능성을 발견하고 격려하며, 공동체를 하나로 모으는 인도력과 비전·감동을 전염시키는 능력이 탁월합니다.",
  weaknessShort:
    "모든 사람을 돕고 싶어 하는 마음 때문에 거절이 어렵고, 정서적·영적으로 쉽게 소진될 수 있습니다.",
  warningShort:
    "타인의 기대와 감정을 모두 품으려다 정작 자신의 영혼과 하나님과의 관계를 돌보지 못할 수 있으니, 나만의 회복 시간과 경계를 의도적으로 지키는 것이 중요합니다.",
  verseApply:
    "사람을 격려하고 세우는 당신의 말과 시선이 성령 안에서 사용될 때, 많은 이가 주님께 더 가까이 나아가게 됩니다. 오늘은 떠오르는 한 사람을 위해, 하나님 안에서 본 그 사람의 강점과 가능성을 구체적인 한 문장으로 적어 메시지로 보내 보세요."
},
...
ISTJ: {
  ...
  summary:
    "보이지 않는 자리에서 공동체의 기초가 흐트러지지 않도록 묵묵히 붙들어 주는 사람입니다. 예배가 제시간에 시작되고, 헌금·문서·일정·규칙이 혼란 없이 유지되는 배경에는 종종 ISTJ의 성실한 손길이 있습니다. 감정보다 원칙을, 충동보다 질서를 선택하여 공동체가 안정적으로 걸어갈 수 있는 바닥을 만들어 줍니다.",
  badges: ["전통·성실", "안정·책임"],
  features: [
  ...
  bibleCharacter: "다니엘",
  bibleCharacterDesc:
    "환경이 바뀌어도 기도와 말씀의 삶을 흔들림 없이 지켰던 신실한 자. ISTJ의 꾸준함과 충성을 가장 잘 보여주는 인물입니다.",
  verseRef: "다니엘 6:10",
  ...
  strengthShort:
    "꾸준함과 신실함으로 공동체의 기반을 지키고, 누구보다 안정적인 토대를 세웁니다.",
  weaknessShort:
    "새로운 시도나 변화에 쉽게 마음이 열리지 않아 경직되어 보일 수 있습니다.",
  warningShort:
    "익숙한 방식만 고수하다 보면, 하나님이 여시는 새로운 길과 성장의 기회를 놓칠 수 있습니다.",
  verseApply:
    "작고 성실한 반복이 하나님 나라에서 큰 열매로 이어짐을 보여 줍니다. 오늘도 ‘전에 하던 대로’ 지키는 당신의 작은 기도와 섬김을 하나님께서 기뻐 보고 계심을 기억해 보세요."
},
...
ISFJ: {
  ...
  summary:
    "눈에 띄지 않는 자리에서 공동체를 가장 부드럽게 지탱하는 사람입니다. 사람들이 집에 돌아간 뒤에도 의자를 정돈하고, 떨어진 물건을 주워 놓고, 말없이 필요한 사람을 챙기는 섬세한 손길 속에 당신의 사랑이 담겨 있습니다. 누가 알아주지 않아도, 공동체가 편안함을 느끼도록 ‘환경과 사람을 돌보는 일’ 자체에 진심을 쏟는 헌신형 제자입니다.",
  badges: ["헌신·돌봄", "안정·배려"],
  features: [
  ...
  bibleCharacter: "룻",
  bibleCharacterDesc:
    "시어머니와 함께 끝까지 남아 헌신한 인물로, 조용하지만 깊은 충성과 사랑을 보여 줍니다. 보이지 않는 자리에서 끝까지 함께하는 모습이 ISFJ와 닮았습니다.",
  verseRef: "룻기 1:16",
  verseText:
    "룻이 이르되 나로 어머니를 떠나며 어머니를 따르지 말고 돌아가라 강요하지 마옵소서 어머니께서 가시는 곳에 나도 가고 어머니께서 머무시는 곳에서 나도 머물겠나이다 어머니의 백성이 나의 백성이 되고 어머니의 하나님이 나의 하나님이 되시리니",
  characterEmoji: "🍞",
  ...
  strengthShort:
    "섬세하고 꾸준한 섬김으로 사람들에게 안전함과 편안함을 주며, 공동체에 깊은 신뢰를 쌓습니다.",
  weaknessShort:
    "자신의 필요를 숨기고 혼자 견디다가 지칠 위험이 크고, 마음에 쌓인 서운함을 잘 표현하지 못할 수 있습니다.",
  warningShort:
    "습관처럼 말하는 ‘저는 괜찮아요’ 뒤에 숨은 마음의 신호를 놓치지 않도록, 스스로의 한계를 인정하는 연습이 필요합니다.",
  verseApply:
    "당신의 조용한 헌신도 하나님께 분명히 기록되고 있으며, 그 길 끝에 예비된 은혜가 있음을 보여 줍니다. 오늘은 늘 혼자 감당하던 일 중 한 가지를 ‘함께 하자’고 부탁해 보고, 모든 짐을 혼자 지려 하지 않는 연습을 해 보세요."
},
...
INTJ: {
  ...
  summary:
    "어떤 상황에서도 먼저 ‘전체 그림’을 본 뒤 움직이는 사색가형 리더입니다. 문제를 들으면 감정보다 흐름과 원인을 분석하고, 장기적인 방향과 구조를 떠올리며 “장기적으로는 어떻게 바뀌어야 할까?”를 고민합니다. 말수는 적지만, 필요한 순간 내놓는 한 마디의 통찰로 복잡한 상황을 정리하고, 공동체가 더 건강한 방향으로 가도록 돕는 조용한 설계자입니다.",
  badges: ["통찰·체계", "기획·분별"],
  features: [
  ...
  bibleCharacterDesc:
    "복음의 큰 그림과 교회의 구조를 깊이 고민하며 서신으로 정리한 전략가적 사도입니다. 신학적 통찰과 실제 교회의 삶을 연결한 모습이 INTJ와 잘 닮았습니다.",
  verseRef: "골로새서 1:28",
  verseText:
  ...
  strengthShort:
    "깊이 있고 체계적인 통찰로 방향을 제시하고, 장기적인 성장을 돕는 구조를 설계하는 능력이 탁월합니다.",
  weaknessShort:
    "계획과 이상이 현실보다 앞서가 실행을 미루기 쉽고, 감정 표현이 적어 차갑게 느껴질 수 있습니다.",
  warningShort:
    "생각과 설계가 너무 앞서가면, 지금 눈앞에 있는 사람의 마음과 오늘 필요한 작은 순종을 놓칠 수 있습니다.",
  verseApply:
    "당신이 고민하는 모든 구조와 계획의 중심에는 결국 ‘각 사람을 그리스도 안에서 온전한 자로 세우려 함’이 있음을 상기시켜 줍니다. 오늘은 설계도보다 먼저 한 사람의 이름을 떠올리고, 그를 위한 짧은 기도 한 줄을 적어 보며 하나님께 그 사람의 성장을 맡겨 보세요."
},
...
INFJ: {
  ...
  summary:
    "표면적인 말보다 그 뒤에 숨은 감정과 흐름을 먼저 느끼는 영적 감수성의 사람입니다. 조급한 조언보다 조용한 질문과 침묵으로 마음이 스스로 열릴 시간을 지켜 주며, 많은 이에게 ‘안전하게 들을 수 있는 공간’을 만들어 줍니다. 하나님의 마음과 사람의 마음 사이를 잇는 다리 역할을 자연스럽게 수행하는 조용한 동행자입니다.",
  badges: ["직관·묵상", "의미·치유"],
  features: [
  ...
  bibleCharacterDesc:
    "사랑과 친밀함을 깊이 강조하며 하나님의 마음을 서술한 제자입니다. 내면과 의미를 중요하게 여기는 INFJ의 성향과 잘 닮아 있습니다.",
  verseRef: "요한일서 4:16",
  verseText:
    "우리가 사랑 안에 거하고 하나님은 우리 안에 거하시는 줄을 알고 믿었노니 하나님은 사랑이시라 사랑 안에 거하는 자는 하나님 안에 거하고 하나님도 그의 안에 거하시느니라",
  characterEmoji: "🌙",
  ...
  strengthShort:
    "사람의 내면을 깊이 이해하고 영적으로 안내하며, 치유와 의미의 흐름을 만들어 내는 능력이 탁월합니다.",
  weaknessShort:
    "여러 감정을 깊이 받아들이다 정서적으로 쉽게 지칠 수 있고, 과공감 피로에 취약할 수 있습니다.",
  warningShort:
    "타인의 아픔을 너무 깊이 품다 보면 정작 자신의 심령이 먼저 무너질 수 있으므로, 경계와 쉼이 반드시 필요합니다.",
  verseApply:
    "하나님의 사랑 안에 먼저 머물 때, 복잡한 감정과 이야기 속에서도 길을 잃지 않게 됩니다. 오늘은 누군가를 위해 기도하기 전에 먼저 ‘주님의 사랑 안에 머무는 기도’를 드리며 마음을 하나님 앞에 고요히 놓아 보세요."
},
...
ESTP: {
  ...
  summary:
    "말보다 몸이 먼저 움직이는 해결사형 제자입니다. 길어진 논의 속에서는 답답함을 느끼고, 직접 현장에 가서 상황을 눈으로 보고 손으로 만질 때 비로소 집중이 잘 됩니다. 위기나 돌발 상황 앞에서도 놀라기보다 주변을 재빨리 살피며 ‘지금 가장 먼저 해야 할 일’을 파악하고, 필요한 자리에 먼저 발을 내딛는 사람입니다.",
  badges: ["실행·도전", "현장 중심"],
  features: [
  ...
  bibleCharacter: "베드로",
  bibleCharacterDesc:
    "생각보다 먼저 발을 내딛는 행동파 제자. 충동도 있었지만, 주님을 향한 사랑 때문에 크게 쓰임 받은 인물입니다.",
  verseRef: "마태복음 14:29",
  verseText:
  ...
  strengthShort:
    "두려움 없이 현장에 뛰어들어 실제적인 도움을 주고, 빠른 실행으로 변화를 이끌어내는 능력이 탁월합니다.",
  weaknessShort:
    "충동적으로 먼저 움직이며 계획·조율·안전 점검을 놓칠 수 있고, 위험을 가볍게 여길 때가 있습니다.",
  warningShort:
    "열심히 뛰어가더라도 기도와 분별 없이 앞서 나가면, 지치고 방향을 잃기 쉽다는 것을 기억할 필요가 있습니다.",
  verseApply:
    "주님을 향해 과감하게 뛰어드는 당신의 용기를 격려하면서도, 그 시선이 끝까지 예수님께 고정되기를 초대하는 말씀입니다. 오늘은 어떤 행동을 시작하기 전에 30~60초만 눈을 감고, ‘주님, 이 선택이 정말 주님이 원하시는 우선인가요?’라고 조용히 물어보는 시간을 가져 보세요."
},
...
ESFP: {
  ...
  summary:
    "밝은 에너지와 따뜻한 환대로 사람들의 마음을 자연스럽게 여는 예배자입니다. 음악, 표정, 말투 같은 작은 표현 하나로 분위기를 부드럽게 만들고, 처음 온 이들도 ‘여긴 편안하다’는 인상을 받을 만큼 공간의 공기를 바꾸는 힘이 있습니다. 당신의 존재 자체가 공동체 안에 생기를 불어넣고, 그 기쁨 속에서 사람들은 자연스럽게 하나님께 마음을 열기 시작합니다.",
  ...
  bibleCharacter: "다윗",
  bibleCharacterDesc:
    "춤추며 하나님을 찬양하고, 시를 통해 기쁨과 슬픔을 솔직히 쏟아낸 예배자입니다. 감정을 숨기지 않고 하나님께 표현했던 모습이 ESFP와 잘 닮았습니다.",
  verseRef: "시편 103:1",
  verseText:
    "내 영혼아 여호와를 송축하라 내 속에 있는 것들아 다 그분의 거룩한 이름을 송축하여라",
  characterEmoji: "🎉",
  ...
  strengthShort:
    "사람들을 즐겁게 하고 예배와 모임의 분위기를 활짝 열어, 하나님께 마음을 여는 문을 만들어 줍니다.",
  weaknessShort:
    "감정에 따라 영적 리듬이 쉽게 흔들릴 수 있고, 속마음을 숨긴 채 ‘밝은 모습’을 유지하려 할 수 있습니다.",
  warningShort:
    "즐거운 분위기 뒤에 감추어진 자신의 슬픔과 공허함을 무시하지 않도록, 마음의 신호에 귀 기울일 필요가 있습니다.",
  verseApply:
    "기쁨의 분위기를 넘어, 마음 깊은 곳에서 하나님을 찬양하는 예배자로 부르심을 상기시켜 줍니다. 오늘은 시편 한 편을 소리 내어 읽으며, 기쁨뿐 아니라 슬픔과 두려움까지도 솔직히 고백하며 그분께 올려 드려 보세요."
},
...
ENTP: {
  ...
  summary:
    "사람들이 당연하게 넘기는 지점에서 ‘왜요?’라고 묻는 탐구형 리더입니다. 이 질문은 비판이 아니라 더 깊은 이해를 향한 움직임이며, 신앙·문화·전통·사회가 부딪히는 지점에서도 두려움 없이 본질을 파고들어 새로운 관점을 제시합니다. 당신이 있는 자리에서는 대화가 깊어지고, 굳어 있던 생각의 틀이 자연스럽게 흔들리며, 더 넓은 가능성이 열립니다.",
  ...
  bibleCharacterDesc:
    "각 도시에서 회당과 광장에서 사람들과 토론하며 복음을 변증했던 사도입니다. 논리와 열정을 결합해 복음을 다양한 문화 속에서 설명했던 모습이 ENTP와 닮았습니다.",
  verseRef: "사도행전 17:17",
  verseText:
    "바울이 회당에서는 유대인들과 경건한 사람들과 또 저자에서는 날마다 만나는 사람들과 변론하니",
  characterEmoji: "💡",
  ...
  strengthShort:
    "창의적인 관점과 논리로 새로운 길을 열고, 복음을 시대의 언어로 설명하는 능력이 탁월합니다.",
  weaknessShort:
    "안정성과 일관성이 부족해 보일 수 있으며, 논쟁의 승패에 마음이 기울면 관계가 소홀해질 위험이 있습니다.",
  warningShort:
    "이기기 위한 논쟁이 되면 상대의 마음과 복음의 본질을 놓칠 수 있으니, ‘연결’을 우선순위에 두는 것이 중요합니다.",
  verseApply:
    "당신의 질문과 논리가 사람을 꺾는 무기가 아니라, 복음을 더 깊이 이해하게 하는 통로가 되도록 이끄는 말씀입니다. 오늘은 대화를 시작하기 전에 상대의 말을 한 문장으로 요약해 주고, ‘내가 맞다’보다 ‘함께 진리에 가까워지자’는 마음으로 대화를 열어 보세요."
},
...
ENFP: {
  ...
  summary:
    "스토리와 진심으로 마음의 문을 여는 전도자형 리더입니다. 자신의 상처와 회복을 숨기지 않고 자연스럽게 나누기 때문에, 듣는 이들은 ‘나만 그런 게 아니구나’라는 위로를 받습니다. 굳어 있던 모임도 당신의 한마디로 분위기가 금세 따뜻해지고, 그 안에서 사람들은 ‘나도 하나님을 다시 만나 보고 싶다’는 소원을 품게 됩니다.",
  badges: ["열정·영감", "스토리·전도"],
  features: [
  ...
  bibleCharacterDesc:
    "예수를 만난 후 자신의 이야기를 가지고 마을 사람들에게 기쁜 소식을 전했던 인물입니다. 은혜의 경험을 ‘와서 보라’는 한 문장으로 풀어낸 모습이 ENFP의 스토리 전도와 잘 닮았습니다.",
  verseRef: "요한복음 4:29",
  verseText:
  ...
  strengthShort:
    "사람들의 마음에 믿음의 용기와 열정을 불어넣고, 복음을 살아 있는 이야기로 전하는 능력이 탁월합니다.",
  weaknessShort:
    "시작은 빠르지만 계획과 마무리가 약해, 아이디어와 시도가 중간에 흩어질 위험이 있고 감정 기복에 따라 사역의 리듬이 흔들릴 수 있습니다.",
  warningShort:
    "감정과 열정이 식는다고 해서 하나님이 멀어지신 것은 아니라는 사실을 잊지 말아야 합니다.",
  verseApply:
    "당신의 스토리와 감동을 통해 많은 사람이 예수님을 보고 싶어지도록 이끄는 삶으로 부르심을 확인하게 합니다. 오늘은 한 사람을 떠올리며, 그에게 들려줄 수 있는 3분 간증을 간단히 적어 보고, 실제로 나누는 한 걸음을 내딛어 보세요."
},
  ...
  summary:
    "말보다 행동으로 사랑을 보여주는 사람입니다. 상황을 빠르게 파악하고, 감정에 휘둘리지 않은 채 본질적인 도움을 건네는 ‘조용한 해결자’입니다. 누군가 말 없이 곁에 있어 주는 위로가 필요할 때, 가장 큰 힘이 되어 주는 유형입니다.",
  badges: ["실용·침착", "조용한 도움"],
  features: [
  ...
  bibleCharacter: "브살렐",
  bibleCharacterDesc:
    "겉으로 드러나지 않는 자리에서 정교하게 성막을 지어 올린 장인. 조용한 집중력과 실력으로 하나님의 일을 완성했습니다.",
  verseRef: "출애굽기 31:3",
  verseText:
    "“하나님의 영을 그에게 충만하게 하여서 지혜와 총명과 지식과 여러 가지 일을 하게 하였다”",
  characterEmoji: "🛠️",
  characterTitle: "조용한 장인의 손길",
  characterStory:
    "어떤 이는 말로 위로하고, 어떤 이는 격려로 사람을 세웁니다. ISTP는 말보다 한 번의 행동으로 공동체를 지탱합니다. 예배 전후 아무도 요청하지 않은 작은 일들을 조용히 챙기고, 누군가 힘들어 보이면 말없이 옆자리를 지켜주는 따뜻함으로 공동체를 숨 쉬게 합니다. 사람들이 미처 알아채지 못한 그 한 걸음이, 누군가에겐 큰 위로가 되곤 합니다.",
  ministries: [
  ...
  strengthShort:
    "상황을 명확히 보고, 불필요한 소음 없이 필요한 도움을 정확하게 건네는 ‘실질적 안정감’을 제공합니다.",
  weaknessShort:
    "감정 표현이 적어 거리감 있게 느껴질 수 있고, 혼자 떠안는 경향 때문에 쉽게 지칠 수 있습니다.",
  warningShort:
    "혼자 모든 일을 감당하려다 자신의 마음과 영적 상태를 챙기지 못하는 위험이 있습니다.",
  verseApply:
    "하나님은 당신의 조용한 실천 속에서도 선하게 일하고 계십니다. 오늘은 작은 행동 하나를 마친 뒤, ‘주님, 이 수고를 당신께 드립니다’라고 짧게 고백해 보세요."
},
...
ISFP: {
  ...
  summary:
    "온유와 아름다움으로 공동체를 따뜻하게 하는 예배자입니다. 크게 드러나지 않는 섬김 속에서 마음을 전하는 것이 당신의 방식입니다. 반주를 맡고, 공간을 조용히 정리하고, 색감 하나·조명 하나를 부드럽게 조정하는 작은 손길 속에 진심이 담겨 있습니다. 당신이 손을 거친 예배 공간에는 설명하기 어려운 평안이 흐르고, 사람들은 자연스럽게 더 머물고 싶어집니다.",
  ...
  bibleCharacterDesc:
    "값비싼 향유를 조용히 부어 사랑을 표현한 예배자입니다. 말보다 행동과 아름다운 헌신으로 주님께 마음을 드린 모습이 ISFP와 닮았습니다.",
  verseRef: "마가복음 14:8",
  verseText:
  ...
  strengthShort:
    "온유하고 따뜻한 예술적 표현으로 사람들의 마음을 위로하고, 예배와 공동체에 은근한 아름다움을 더합니다.",
  weaknessShort:
    "갈등과 비판을 두려워해 자신의 의견을 숨기기 쉽고, 상처와 서운함을 마음에 오래 담아둘 수 있습니다.",
  warningShort:
    "조용히 참고만 있다 보면, 말하지 못한 감정이 마음속에 쌓였다가 어느 날 한 번에 터질 수 있습니다.",
  verseApply:
    "보이는 성과보다 마음을 다한 작은 헌신을 기쁘게 받으시는 주님의 마음을 보여 주는 말씀입니다. 오늘은 떠오르는 한 사람을 위해 작은 그림, 손글씨 메모, 음악 링크 하나라도 정성껏 준비해 건네며, 그 사람을 주님의 위로 안에 맡겨 보세요.",
},
...
INTP: {
  ...
  summary:
    "무엇이든 ‘정확하게’ 이해하고 싶어 하는 사색가형 예배자입니다. 막연한 설명이나 감정적인 주장보다 “이 의미는 무엇인가?”, “이 구조는 어떻게 연결되는가?”를 먼저 살피며, 머릿속에서 성경·교리·세계관을 조용히 정리해 가는 편입니다. 겉으로는 말수가 적어 보여도 내면에서는 늘 분석·탐구·분별이 동시에 흐르고 있습니다.",
  badges: ["논리·탐구", "신학·분석"],
  features: [
  ...
  bibleCharacter: "누가",
  bibleCharacterDesc:
    "모든 사실을 자세히 조사해 복음서와 사도행전을 기록한 의사 누가처럼, 분석과 기록을 통해 진리를 선명하게 세우는 모습이 INTP와 잘 닮았습니다.",
  verseRef: "누가복음 1:3",
  verseText:
  ...
  strengthShort:
    "깊이 있는 이해와 논리로 진리를 설명하고, 공동체의 신앙 내용을 단단하게 세우는 데 탁월합니다.",
  weaknessShort:
    "머릿속에만 머물고 행동으로 옮기지 못할 위험이 있으며, 차갑게 느껴지는 표현으로 사람을 상처 입힐 수 있습니다.",
  warningShort:
    "완벽히 이해해야만 순종할 수 있다고 느끼지 않도록 주의해야 합니다. 신앙은 때로 ‘불완전한 이해 속 작은 순종’에서 자랍니다.",
  verseApply:
    "당신의 탐구와 기록이 사람들을 예수님께 더 가까이 이끄는 통로가 되도록 돕는 말씀입니다. 오늘은 공부한 내용 중 ‘실제로 하나 바꿀 수 있는 적용’을 정해 적어 보고, 작게라도 실천해 보세요."
},
...
INFP: {
  ...
  summary:
    "어떤 일을 하든 ‘마음의 진정성’을 가장 중요하게 여기는 이상가형 제자입니다. 겉으로는 조용해 보여도, 내면에서는 “이 방향이 하나님께 기쁨이 될까?”, “이 선택이 양심에 평안한가?”를 깊이 묻습니다. 화려하지 않아도, 말이 많지 않아도, 당신이 있는 공동체에는 자연스러운 따뜻함과 진심의 분위기가 흐릅니다.",
  badges: ["가치·소명", "공감·상상"],
  features: [
  ...
  bibleCharacter: "예레미야",
  bibleCharacterDesc:
    "하나님의 마음을 깊이 느끼고 눈물로 기도했던 선지자입니다. 예민하고 깊은 마음으로 시대와 하나님의 뜻 사이에서 씨름했던 모습이 INFP와 닮았습니다.",
  verseRef: "예레미야 20:9",
  verseText:
  ...
  strengthShort:
    "깊고 순수한 마음으로 하나님과 사람을 사랑하며, 상처 입은 이들을 섬세하게 품어 줄 수 있습니다.",
  weaknessShort:
    "현실의 거친 면을 마주할 때 쉽게 상처받을 수 있고, 실망이 클수록 관계와 공동체에서 멀어지려는 경향이 있습니다.",
  warningShort:
    "실망 때문에 마음의 문을 닫아 버리면, 하나님께 받은 부르심과 아름다운 가능성도 함께 가려질 수 있습니다.",
  verseApply:
    "당신의 마음속에 있는 불씨가 하나님 안에서 꺼지지 않도록 붙들어 주는 말씀입니다. 오늘은 감정 한 줄과 말씀 한 줄을 적어 짧은 기도시로 써 보고, 한 사람과 나누거나 하나님께만 조용히 올려 드려 보세요."
},
